...
export enum apiRoutes {
  ...
  SchoolPrograms = "/school-programs/?per_page=100",
  Pages = "/custom-pages/?per_page=100",
  ...
  SocialNetworks = "/social-networks/?per_page=100",
  // wordpres routes
  WpCategories = "/categories/?per_page=100",
}
